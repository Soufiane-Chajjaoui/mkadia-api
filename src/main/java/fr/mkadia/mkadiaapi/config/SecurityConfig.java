    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests(
                        req -> {
                            req.requestMatchers("/api/v1/auth/login" , "/api/v1/auth/register", "/api/v1/auth/forget-secretKey", "/api/v1/auth/check-verification", "/api/v1/auth/reset-secretKey", "/v3/api-docs", "/swagger-ui/**")
                                    .permitAll();
                            req.anyRequest()
                                    .authenticated();
                        }
